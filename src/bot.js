...
await bot.sendMessage(839036065, `Hej! New chats started successed ${JSON.stringify(runBot.telegram)}`);
const runBot2 = await sendToServer(query2);

const runBot3 = sendToServer(query3);
await bot.sendMessage(839036065, `Hej! New chats started successed ${JSON.stringify(runBot2.telegram)}`);
